 ...
 */
public class ExcludeSqlFilter extends ExcludFilter {

	private long connectId;// 数据库连接

	public ExcludeSqlFilter(long connectId, String fieldName, String fieldText, String prototype) {
...
//			statement = conn.prepareStatement(filterText);
			statement = taskConn.prepareStatement(filterText);
			...
			throw new Exception("初始化<ExcludeSqlFilter>失败（" + e.getMessage() +"）", e);
		} finally {
